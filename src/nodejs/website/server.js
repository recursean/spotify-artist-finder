...
app.get('/', function (req, res) {
    fs.readFile("html/index.html", "utf8", function(err, html){
        if(err)
            ...
            fillTable(html, typeof req.query.start === "undefined" ? 1 : req.query.start, 25, function(modHTML){
                res.send(modHTML);
            });
        }
    });
...
function fillTable(html, startIdx, resultSize, callback){
